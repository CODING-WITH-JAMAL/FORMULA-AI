...
def settings():
    ...
    background_entry = Entry(settings_window, width = 20)
    background_entry_button = Button(settings_window, text = "change", command=colour_change)
    background_entry.pack()
    background_entry_button.pack()
    settings_window.mainloop()


settings_button = Button(main_window, text = "settings")
settings_button.config(bg = "black", fg = "blue", command = settings, width = 10, activebackground="green", activeforeground="red")
...
search_entry = Entry(main_window, width = 30)
search_button = Button(main_window, text = "SEARCH", command = button_function)
search_button.config(bg = "black", fg = "blue", activebackground="green", activeforeground="red")
help_button = Button(main_window, text = "HELP")
help_button.config(command = help, bg = "black", fg = "blue", width = 10, activebackground="green", activeforeground="red")

pro_button = Button(main_window, text = "PRO")
pro_button.config(bg = "black", fg = "blue", padx = 5, pady = 5, width = 10, command = pro_function, activebackground="green", activeforeground="red")
pro_button.place(x=0,y=100)

search_entry.pack()
search_button.pack()
help_button.place(x=0,y=27)
